...
export const loginUser = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const userObj = await createNewUserObj(req, 'login') // same as with register path, this function does the validation and if error occurs it gets caught in "app.ts" inside routes error handler
